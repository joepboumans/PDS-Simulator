...
def main():
   setup_dataset_length("equinix-chicago.20160121-130000.UTC.pcap", "small_test", 1024)
   setup_dataset_length("equinix-chicago.20160121-130000.UTC.pcap", "smaller_test", 32)
